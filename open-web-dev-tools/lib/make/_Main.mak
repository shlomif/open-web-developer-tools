...
TYPESCRIPT_DEST_FILES = $(D)/js/tools/lowercase.js $(D)/js/tools/uppercase.js $(D)/js/tools-tests-1.js $(D)/js/tools-test-lowercase.js $(D)/js/open-web-dev-tools--base.js
